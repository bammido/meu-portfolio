...
export default function ExperienceCard() {
    ...
    return <a target="_blank" href="https://www.frameworkdigital.com.br/" className="experience-card">
        ...
        <div className="experience-resume">
            ...
            <p>Minha jornada como desenvolvedor ganhou forma na Framework, empresa especializada em fornecer equipes de alto desempenho em tecnologia para diversas indústrias. Nesse contexto, desempenhei um papel-chave em um projeto destinado a uma grande funerária.</p>
