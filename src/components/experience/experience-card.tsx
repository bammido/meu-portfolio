...
export default function ExperienceCard({}){
    ...
    return <a target="_blank" href="https://www.frameworkdigital.com.br/" className="experience-card">
        ...
        <div className="experience-resume">
            <h3>Estagiário de Desenvolvimento Web - Framework Digital</h3>
            <p>Minha jornada como desenvolvedor Fullstack ganhou forma durante um estágio na Framework, uma renomada empresa especializada em fornecer equipes de alto desempenho em tecnologia para diversas indústrias. Nesse contexto, desempenhei um papel-chave em um projeto destinado a uma grande funerária.</p>
