export const experiences = [
    ...
    },
    {
        description: <p>
            <ul>
                <li>
                    <b>Integrações complexas:</b> Desenvolvimento de integrações com serviços externos e de terceiros, como gateways de pagamento, sistemas de CRM e soluções de armazenamento em nuvem.
                </li>
                <li>
                    <b>Manutenção e refatoração de código:</b> Otimização e refatoração contínua do código base, melhorando a performance e a escalabilidade de sistemas web utilizando React e Node.js.
                </li>
                <li>
                    <b>Automatização de processos:</b> Implementação de pipelines de CI/CD (integração contínua e entrega contínua) para garantir a entrega ágil e eficiente de novas versões de software.
                </li>
            </ul>
        </p>,
        technologies: ["React", "Node", "Typescript", "Next", "Nest", "SQL", "Docker", "AWS", "Type ORM", "Sequelize", "Gitflow"],
